...
docker-compose -f docker-compose-qa.yml run qa sh -c "rake db:migrate"
docker-compose -f docker-compose-qa.yml run -d --publish 3000:3000 --name veracity_backend  --entrypoint "sh /app/docker-onrun.sh" qa
